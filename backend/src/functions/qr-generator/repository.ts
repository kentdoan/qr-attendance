...
import { QrTokenItem, SessionSummary } from './types';
...
export const getSession = async (sessionId: string): Promise<SessionSummary | null> => {
  ...
  return (response.Item as SessionSummary) || null;
};
